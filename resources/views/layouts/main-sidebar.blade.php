                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="calendar-menu1" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('classrooms.sections')}}">{{trans('main_trans.sections_list')}} </a> </li>
                    ...
                    <li>
                        ...
                        <ul id="calendar-menu2" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('AddParent')}}">{{trans('main_trans.parents_list')}} </a> </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu3">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{trans('main_trans.techers')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>

                        <ul id="calendar-menu3" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('teachers.index')}}">{{trans('main_trans.teachers_all')}} </a> </li>
                        </ul>
                    </li>
