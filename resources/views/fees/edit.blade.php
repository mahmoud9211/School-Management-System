                ...
                {{method_field('patch')}}
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input type="text" name="title_ar" value="{{$fees->getTranslation('title','ar')}}" class="form-control">
                            </div>

                            <div class="form-group col">
                                <label for="inputEmail4">الاسم باللغة الانجليزية</label>
                                <input type="text"  name="title_en" value="{{$fees->getTranslation('title','en')}}" class="form-control">
                            </div>


                            <div class="form-group col">
                                <label for="inputEmail4">المبلغ</label>
                                <input type="number"  name="amount" value="{{$fees->amount}}" class="form-control">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Grade_id">
                                    ...
                                    @foreach($grades as $g)
                                        <option value="{{ $g->id }}" {{$g->id == $fees->Grade_id ? 'selected' : ''}}>{{ $g->name }}</option>
                                    @endforeach
                                </select>
                            </div>
